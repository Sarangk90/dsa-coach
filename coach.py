...
def cmd_design(topic: Optional[str] = None):
...
def main():
    ...
    legacy_commands = {
        "start", "status", "next", "done", "hint", "review",
        "recall", "design", "learn", "mistakes", "today",
        "summary", "sessions", "reset", "note"
    }
