...
def write_note(
    ...
    target_dir = structure["patterns"] if note_type == "pattern" else structure["problems"]
...
def update_note(filepath: Path, new_section: str, section_title: str = "") -> tuple[bool, str]:
...
def note_exists(filename: str, note_type: Literal["pattern", "problem"] = "pattern") -> bool:
