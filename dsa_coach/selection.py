...
def get_next_quest(progress: dict[str, Any]) -> dict[str, Any] | None:
    ...
    incomplete_unlocked = [
        p for p in unlocked if p.get("pattern_id") not in completed_patterns
    ]
    ...
    for problem in all_problems:
        ...
        if problem_id not in completed_problem_ids and is_pattern_unlocked(
            pattern_id, progress, mode
        ):
            return problem
...
def get_next_quest_for_pattern(
    pattern_id: str, progress: dict[str, Any]
) -> dict[str, Any] | None:
